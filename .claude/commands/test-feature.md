---
description: Writes and runs tests for a specific expense feature. Pass the spec name as argument e.g. /test-feature 05-backend-connection
...
Invoke the **expense-test-writer** subagent with the 
following context:
...
Wait for expense-test-writer to fully complete and 
...
Once expense-test-writer has finished, invoke the 
**expense-test-runner** subagent with the following 
context:
...
- If expense-test-writer reports it could not write 
...
**Step 2 — Test Results**
- Mirror the expense-test-runner's structured report
