...
description: Runs parallel security and quality code 
  review for a specific expense feature. Pass the spec 
...
"Please provide a sp/ageec name. Usage: /code-review-feature 
...
**expense-security-reviewer** receives:
...
**expense-quality-reviewer** receives:
- The combined diff from the pre-flight check
- Spec file for context: `.claude/specs/$ARGUMENTS.md`
...
Security Findings
[expense-security-reviewer output]
Quality Findings
[expense-quality-reviewer output]
