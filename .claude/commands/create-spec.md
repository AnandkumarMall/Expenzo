---
description: Create a spec file and feature branch for the next expense step
...
expense expense tracker. Always follow the rules in CLAUDE.md.
...
it exists at this stage of the expense roadmap.
